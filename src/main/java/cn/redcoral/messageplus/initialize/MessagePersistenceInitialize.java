...
public class MessagePersistenceInitialize {
     ...
     * 创建群组的AOP增强
     */
    @Pointcut("execution(public cn.redcoral.messageplus.data.entity.Group cn.redcoral.messageplus.utils.GroupManage.createGroup(String, String, java.util.List))")
    void createGroup() {}
    @Around("createGroup()")
     ...
     * 创建群组的AOP增强
     */
//    @Pointcut("execution(public cn.redcoral.messageplus.data.entity.vo.ChatRoom cn.redcoral.messageplus.utils.ChatRoomManage.createChatRoom(String, String))")
//    void createChatRoom() {}
...
//    }
    ...
    @Pointcut("execution(public cn.redcoral.messageplus.data.entity.vo.ChatRoom cn.redcoral.messageplus.utils.ChatRoomManage.createChatRoom(String, String, String))")
